...
class Cylinder3D(Base3DSegmentor):
    ...
    def encode_decode(self, cylinder_fea, grid_ind, img_metas):
        ...
        """
        x = self.extract_feat(cylinder_fea, grid_ind)
    ...
    def _auxiliary_head_forward_train(self, x, img_metas, voxel_label):
        ...
        if isinstance(self.auxiliary_head, nn.ModuleList):
            ...
            loss_aux = self.auxiliary_head.forward_train(
                x, img_metas, voxel_label, self.train_cfg)
